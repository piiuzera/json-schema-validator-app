...
Gulp.task('UglifyAngularLibs', function() {
	return Gulp.src(['libs/angular/**/*.min.js'])
		.pipe(GulpUglify())
		.pipe(GulpConcat('angular.min.js'))
		.pipe(Gulp.dest('public_html/dist/js'));
});

Gulp.task('UglifyAllLibs', function() {
	return Gulp.src(['libs/**/*.min.js'])
		.pipe(GulpUglify())
		.pipe(GulpConcat('allLibs.min.js'))
		.pipe(Gulp.dest('public_html/dist/js'));
});
...
Gulp.task('default', function(totalTime) {
	return GulpRun('Clean', ['UglifyAngularLibs',
							 'UglifyAllLibs',
							 'JsHintAppJs',
							 'UglifyAppJs',
							 'JsHintControllerJs',
